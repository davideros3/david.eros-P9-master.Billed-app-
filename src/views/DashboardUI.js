      ...
      <div class='dashboard-content'>
        <div class='bills-feed'>
          <div class='status-bills-header'>
            <h3> Pending (${filteredBills(data && data.bills, "pending").length}) </h3>
          ...
          <div class='status-bills-header' style='margin-top: 20px;'>
            <h3> Accepted (${filteredBills(data && data.bills, "accepted").length}) </h3>
          ...
          <div class='status-bills-header' style='margin-top: 20px;'>
            <h3> Refused (${filteredBills(data && data.bills, "refused").length}) </h3>
